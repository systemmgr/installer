...
_am_i_online_completion() {
  ...
  local LONGOPTS="--completions --debug --no-color --options --config --version --help --silent --dir --error --show --console --force --message --site --code --loop"
  local SHORTOPTS="-f -l -m -s"
  local ARRAY=""
