...
# @Created           :  Wednesday, Dec 08, 2021 10:35 EST
# @File              :  ytstream
...
_ytstream() {
  ...
  local CONFDIR="$HOME/.config/myscripts/ytstream"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/ytstream}"
