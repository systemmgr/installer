...
_cmdfu() {
  ...
  local CONFDIR="$HOME/.config/myscripts/cmdfu"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/cmdfu}"
  ...
  local SHORTOPTS=""
  local ARRAY="search browse latest user"
