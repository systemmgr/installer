...
_check-for-updates() {
  ...
  local CONFDIR="$HOME/.config/myscripts/check-for-updates"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/check-for-updates}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _check-for-updates check-for-updates
