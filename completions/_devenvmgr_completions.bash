...
# @File              :  devenvmgr
# @Description       :  Setup a development environment with modern frameworks and Docker support
...
_devenvmgr() {
  ...
  local CONFDIR="$HOME/.config/myscripts/devenvmgr"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/devenvmgr}"
  ...
  local ARRAY+="vue svelte astro nextjs nuxt bun dockerfile devcontainer dockercompose "
  local START="jekyll"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _devenvmgr devenvmgr
