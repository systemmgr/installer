...
_thesaurus() {
  ...
  local CONFDIR="$HOME/.config/myscripts/thesaurus"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/thesaurus}"
  ...
  local SHORTOPTS=""
  local ARRAY="antonyms antonym related rhyme rhymes topic"
