...
# @TODO              :
# @Other             :
# @Resource          :  https://github.com/gslewis/tash
# - - - - - - - - - - - - - - - - - - - - - - - - -'
_tash() {
  ...
  local CONFDIR="$HOME/.config/myscripts/tash"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/tash}"
  ...
  local SHORTOPTS="-z -f -h -p -a -n -t -v -V"
  local ARRAY=""
