...
_findInstallApp() {
  ...
  local CONFDIR="$HOME/.config/myscripts/findInstallApp"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/findInstallApp}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _findInstallApp findInstallApp
