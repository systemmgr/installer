...
# @@Created          :  Sunday, Jul 17, 2022 15:49 EDT
# @@File             :  detectostype
...
_detectostype() {
  ...
  local CONFDIR="$HOME/.config/myscripts/detectostype"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/detectostype}"
  ...
  local SHORTOPTS=""
  local ARRAY="all arch name type"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _detectostype detectostype
