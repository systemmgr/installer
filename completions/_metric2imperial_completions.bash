...
_metric2imperial() {
  ...
  local CONFDIR="$HOME/.config/myscripts/metric2imperial"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/metric2imperial}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _metric2imperial metric2imperial
