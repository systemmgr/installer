...
_random-string() {
  ...
  local CONFDIR="$HOME/.config/myscripts/random-string"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/random-string}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _random-string random-string
