...
# @@Created          :  Monday, May 08, 2023 12:31 EDT
# @@File             :  rmd
...
_rmd_completion() {
  ...
  CONFDIR="$HOME/.config/myscripts/rmd"
  SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/rmd}"
  #####################################################################
  SHOW_COMP_OPTS=""
  #####################################################################
  SHORTOPTS=""
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _rmd_completion -o default rmd
