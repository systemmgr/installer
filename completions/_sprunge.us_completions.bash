...
_sprunge.us() {
  ...
  local CONFDIR="$HOME/.config/myscripts/sprunge.us"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/sprunge.us}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _sprunge.us sprunge.us
