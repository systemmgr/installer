...
_auto_tail_completion() {
  ...
  CONFDIR="$HOME/.config/myscripts/auto_tail"
  SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/auto_tail}"
  #####################################################################
  SHOW_COMP_OPTS=""
  #####################################################################
  SHORTOPTS=""
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _auto_tail_completion -o default auto_tail
