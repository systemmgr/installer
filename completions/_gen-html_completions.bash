...
# @Created           :  Friday, Dec 24, 2021 14:03 EST
# @File              :  gen-html
...
_gen-html() {
  ...
  local CONFDIR="$HOME/.config/myscripts/gen-html"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/gen-html}"
