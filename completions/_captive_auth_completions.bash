...
# @@File             :  captive-auth
# @@Description      :  Completions for captive-auth
...
_captive_auth_completion() {
  ...
  CONFDIR="$HOME/.config/myscripts/captive-auth"
  SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/captive-auth}"
  #####################################################################
  SHOW_COMP_OPTS=""
  #####################################################################
  SHORTOPTS=""
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _captive_auth_completion -o default captive-auth
