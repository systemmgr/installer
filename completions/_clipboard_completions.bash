...
# @Created           :  Thursday, Oct 28, 2021 16:11 EDT
# @File              :  clipboard
...
_clipboard() {
  ...
  local CONFDIR="$HOME/.config/myscripts/clipboard"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/clipboard}"
  ...
  local SHORTOPTS=""
  local ARRAY="clear show print put"
