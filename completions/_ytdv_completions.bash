...
# @@Created          :  Sunday, May 28, 2023 12:06 EDT
# @@File             :  ytdv
# @@Description      :
...
_ytdv_completion() {
  ...
  CONFDIR="$HOME/.config/myscripts/ytdv"
  SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/ytdv}"
  #####################################################################
  SHOW_COMP_OPTS=""
  #####################################################################
  SHORTOPTS=""
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _ytdv_completion -o default ytdv
