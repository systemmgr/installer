...
# @Created           :  Wednesday, Jan 12, 2022 11:22 EST
...
_client-installs() {
  ...
  local CONFDIR="$HOME/.config/myscripts/client-installs"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/client-installs}"
  ...
  local SHORTOPTS=""
  local ARRAY="anime lockdoor misspell"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _client-installs client-installs
