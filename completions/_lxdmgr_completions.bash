#!/usr/bin/env bash
# - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202207021609-git
# @Author            :  Jason Hempstead
# @Contact           :  jason@casjaysdev.pro
# @License           :  WTFPL
# @ReadME            :  lxdmgr --help
# @Copyright         :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @Created           :  Saturday, Jul 02, 2022 16:09 EDT
# @File              :  lxdmgr
# @Description       :
# @TODO              :
# @Other             :
...
_lxdmgr() {
  ...
  local CONFDIR="$HOME/.config/myscripts/lxdmgr"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/lxdmgr}"
  ...
  local SHORTOPTS=""
  local ARRAY="init check create stop start restart delete exec search info list run panel"
