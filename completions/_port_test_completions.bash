...
# @File              :  port_test
# @Description       :  autocomplete for port_test
# @TODO              :
# @Other             :
# @Resource          :
# - - - - - - - - - - - - - - - - - - - - - - - - -
_port_test() {
  ...
  local CONFDIR="$HOME/.config/myscripts/port_test"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/port_test}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _port_test port_test
