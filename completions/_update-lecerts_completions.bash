...
_update_lecerts() {
  ...
  local CONFDIR="$HOME/.config/myscripts/update-lecerts"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/update-lecerts}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _update_lecerts update-lecerts
