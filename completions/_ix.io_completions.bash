...
_ix.io() {
  ...
  local CONFDIR="$HOME/.config/myscripts/ix.io"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/ix.io}"
  ...
  local SHORTOPTS="-z -d -i -n"
  local ARRAY="latest user id raw post create"
