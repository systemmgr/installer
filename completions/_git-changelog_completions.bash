...
# @License           :  WTFPL
# @ReadME            :  git-changelog --help
# @Copyright         :  Copyright: (c) 2021 Jason Hempstead, Casjays Developments
# @Created           :  Thursday, Aug 12, 2021 19:03 EDT
# @File              :  git-changelog
# @Description       :  Generate a human-readable change log from a git repo
# @TODO              :
# @Other             :
# @Resource          :  https://github.com/DannyBen/bashly
# - - - - - - - - - - - - - - - - - - - - - - - - -'
_git-changelog() {
  ...
  local CONFDIR="$HOME/.config/myscripts/git-changelog"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/git-changelog}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _git-changelog git-changelog
