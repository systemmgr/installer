...
_music() {
  ...
  local CONFDIR="$HOME/.config/myscripts/music"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/music}"
  ...
  local SHORTOPTS=""
  local ARRAY="mpc vlc cmus mplayer ncmpcpp castero spotifyd pandora pianobar tizonia radio curseradio-improved youtube-viewer"
