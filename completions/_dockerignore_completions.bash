...
# @File              :  dockerignore
# @Description       :  Docker ignore file generator
# @TODO              :
# @Other             :
# @Resource          :
# - - - - - - - - - - - - - - - - - - - - - - - - -'
_dockerignore() {
  ...
  local CONFDIR="$HOME/.config/myscripts/dockerignore"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/dockerignore}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _dockerignore dockerignore
