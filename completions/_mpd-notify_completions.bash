...
_mpd-notify() {
  ...
  local CONFDIR="$HOME/.config/myscripts/mpd-notify"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/mpd-notify}"
  ...
  local SHORTOPTS=""
  local ARRAY="term toggle restart status stop start run enable disable"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _mpd-notify mpd-notify
