...
# @File              :  sysusage
# @Description       :  autocomplete for sysusage
# @TODO              :
# @Other             :
# @Resource          :
# - - - - - - - - - - - - - - - - - - - - - - - - -
_sysusage() {
  ...
  local CONFDIR="$HOME/.config/myscripts/sysusage"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/sysusage}"
