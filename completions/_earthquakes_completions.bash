...
_earthquakes() {
  ...
  local CONFDIR="$HOME/.config/myscripts/earthquakes"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/earthquakes}"
  local SHOW_COMP_OPTS=""
  local FILEDIR=""
  local OPTS=""
  local LONGOPTS="--completions --debug --no-color --options --config --version --help --silent --dir"
  local SHORTOPTS=""
  local ARRAY="hour day week month"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _earthquakes earthquakes
