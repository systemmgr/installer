...
_sendemail-to_completion() {
  ...
  CONFDIR="$HOME/.config/myscripts/sendemail-to"
  SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/sendemail-to}"
  #####################################################################
  SHOW_COMP_OPTS=""
  #####################################################################
  SHORTOPTS=""
  ...
  LONGOPTS+="--recipient --from --subject"
  #####################################################################
  #NOOPTS="--no-* "
  #####################################################################
  ARRAY=""
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _sendemail-to_completion -o default sendemail-to
