...
_dmenurecord() {
  ...
  local CONFDIR="$HOME/.config/myscripts/dmenurecord"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/dmenurecord}"
  ...
  local SHORTOPTS=""
  local ARRAY="screencast audio video stop"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _dmenurecord dmenurecord
