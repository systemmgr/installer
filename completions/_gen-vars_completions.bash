...
# @@License          :  WTFPL
# @@ReadME           :  gen-vars --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Saturday, Aug 19, 2023 00:07 EDT
# @@File             :  gen-vars
# @@Description      :
# @@Changelog        :
...
_gen-vars_completion() {
  ...
  CONFDIR="$HOME/.config/myscripts/gen-vars"
  SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/gen-vars}"
  #####################################################################
  SHOW_COMP_OPTS=""
  #####################################################################
  SHORTOPTS=""
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _gen-vars_completion -o default gen-vars
