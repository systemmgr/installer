...
_blog_completion() {
  ...
  local FILEDIR=""
  local LONGOPTS="--completions --debug --no-color --options --config --version --help --silent --dir --file "
  local SHORTOPTS="-f"
  local ARRAY="config copy new edit page post"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _blog_completion blog
