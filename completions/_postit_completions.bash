...
# @Created           :  Friday, Dec 10, 2021 17:47 EST
# @File              :  postit
...
_postit() {
  ...
  local CONFDIR="$HOME/.config/myscripts/postit"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/postit}"
  ...
  local SHORTOPTS=""
  local ARRAY="create edit delete"
