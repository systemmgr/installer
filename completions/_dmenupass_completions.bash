...
# @License           :  WTFPL
# @ReadME            :  dmenupass --help
# @Copyright         :  Copyright: (c) 2021 Jason Hempstead, Casjays Developments
# @Created           :  Thursday, Aug 12, 2021 19:03 EDT
# @File              :  dmenupass
# @Description       :  Have dmenu ask for sudo password
# @TODO              :
# @Other             :
# @Resource          :
# - - - - - - - - - - - - - - - - - - - - - - - - -'
_dmenupass() {
  ...
  local CONFDIR="$HOME/.config/myscripts/dmenupass"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/dmenupass}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _dmenupass dmenupass
