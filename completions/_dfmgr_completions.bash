...
# @Changelog         :  Synchronized versions with script and man page
# @TODO              :
# @Other             :
# @Resource          :
# - - - - - - - - - - - - - - - - - - - - - - - - -'
_dfmgr() {
  ...
  local LIST+="dircolors dmenu dunst easytag emacs firefox fish geany git gtk-2.0 gtk-3.0 guake "
  local LIST+="htop installer jgmenu lemonbar lf lua misc mpd mutt nano neofetch neovim newsboat "
  local LIST+="nitrogen nodejs personal pianobar picard polybar powershell pragha qterminal ranger "
  local LIST+="remmina rofi ruby sakura screen smplayer smtube st sxhkd terminology termite Thunar tig tint2 "
  local LIST+="tmux transmission variety vifm vim volumeicon xfce4-terminal youtube-dl youtube-viewer ytmdl zsh "
