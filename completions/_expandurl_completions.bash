...
_expandurl() {
  ...
  local CONFDIR="$HOME/.config/myscripts/expandurl"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/expandurl}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _expandurl expandurl
