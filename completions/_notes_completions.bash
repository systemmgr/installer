...
_notes() {
  ...
  local CONFDIR="$HOME/.config/myscripts/notes"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/notes}"
  local NOTES_DIR="${NOTES_DIRECTORY:-$HOME/.local/share/editors/notes}"
  ...
  local ARRAY="server service client open sync show list search all"
