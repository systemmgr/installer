...
# @@Created          :  Sunday, Jul 17, 2022 16:15 EDT
# @@File             :  run_command
...
_run_command() {
  ...
  local CONFDIR="$HOME/.config/myscripts/run_command"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/run_command}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _run_command run_command
