...
# @Created           :  Monday, Jan 24, 2022 02:06 EST
# @File              :  currency
# @Description       :
# @TODO              :
# @Other             :
...
_currency() {
  ...
  local CONFDIR="$HOME/.config/myscripts/currency"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/currency}"
