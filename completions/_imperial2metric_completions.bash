...
_imperial2metric() {
  ...
  local CONFDIR="$HOME/.config/myscripts/imperial2metric"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/imperial2metric}"
  ...
  local SHORTOPTS=""
  local ARRAY="dollars pounds miles yards feet inches f"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _imperial2metric imperial2metric
