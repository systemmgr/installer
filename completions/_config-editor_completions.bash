...
_config-editor_completion() {
  ...
  CONFDIR="$HOME/.config/myscripts/config-editor"
  SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/config-editor}"
  #####################################################################
  SHOW_COMP_OPTS=""
  #####################################################################
  SHORTOPTS=""
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _config-editor_completion -o default -o nospace config-editor
