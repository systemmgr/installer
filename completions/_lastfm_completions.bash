...
_lastfm_completion() {
  ...
  CONFDIR="$HOME/.config/myscripts/lastfm"
  SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/lastfm}"
  #####################################################################
  SHOW_COMP_OPTS=""
  #####################################################################
  SHORTOPTS=""
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _lastfm_completion -o default lastfm
