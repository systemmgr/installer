...
# @License           :  WTFPL
# @ReadME            :  send-notify --help
# @Copyright         :  Copyright: (c) 2025 Jason Hempstead, Casjays Developments
# @Created           :  Monday, Oct 14, 2025 15:00 EDT
# @File              :  send-notify
# @Description       :  autocomplete for send-notify
# @TODO              :
# @Other             :
# @Resource          :
# - - - - - - - - - - - - - - - - - - - - - - - - -
_send_notify() {
  ...
  local CONFDIR="$HOME/.config/myscripts/send-notify"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/send-notify}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _send_notify send-notify
