...
_publishit() {
  ...
  local CONFDIR="$HOME/.config/myscripts/publishit"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/publishit}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _publishit publishit
