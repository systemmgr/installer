...
_diskusage_completion() {
  ...
  CONFDIR="$HOME/.config/myscripts/diskusage"
  SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/diskusage}"
  #####################################################################
  SHOW_COMP_OPTS=""
  #####################################################################
  SHORTOPTS=""
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _diskusage_completion -o default diskusage
