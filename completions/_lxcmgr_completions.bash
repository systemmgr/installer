...
# @File              :  lxcmgr
# @Description       :  LXC container manager
# @TODO              :
# @Other             :
# @Resource          :
# - - - - - - - - - - - - - - - - - - - - - - - - -'
_lxcmgr() {
  ...
  local CONFDIR="$HOME/.config/myscripts/lxcmgr"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/lxcmgr}"
