...
_ifinstalled() {
  ...
  local CONFDIR="$HOME/.config/myscripts/ifinstalled"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/ifinstalled}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _ifinstalled ifinstalled
