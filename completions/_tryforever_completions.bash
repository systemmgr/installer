...
# @File              :  tryforever
# @Description       :  Keep an app running until it successfully completes
# @TODO              :
# @Other             :
# @Resource          :
# - - - - - - - - - - - - - - - - - - - - - - - - -'
_tryforever() {
  ...
  local CONFDIR="$HOME/.config/myscripts/tryforever"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/tryforever}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _tryforever tryforever
