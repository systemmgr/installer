...
# @Created           :  Tuesday, Jan 18, 2022 14:22 EST
# @File              :  gen-network
# @Description       :
# @TODO              :
# @Other             :
...
_gen-network() {
  ...
  local CONFDIR="$HOME/.config/myscripts/gen-network"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/gen-network}"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _gen-network gen-network
