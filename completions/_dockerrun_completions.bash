...
_dockerrun_completion() {
  ...
  CONFDIR="$HOME/.config/myscripts/dockerrun"
  SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/dockerrun}/lists"
  #####################################################################
  SHOW_COMP_OPTS=""
  #####################################################################
  SHORTOPTS=""
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _dockerrun_completion -o default dockerrun
