...
_run_options_completion() {
  ...
  CONFDIR="$HOME/.config/myscripts/run_options"
  SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/run_options}"
  #####################################################################
  SHOW_COMP_OPTS=""
  #####################################################################
  SHORTOPTS=""
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _run_options_completion -o default run_options
