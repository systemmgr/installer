...
_search-menu_completion() {
  ...
  #####################################################################
  ENGINES_DEV="github gitlab googleOpenSource sourceforge stackoverflow"
  ENGINES_GENERAL="scour duckduckgo google brave bing startpage searx"
  ENGINES_NEWS="wikipedia wiktionary googlenews hackernews cnn bbcnews reuters"
  ENGINES_MEDIA="reddit odysee youtube"
  ENGINES_OS="archwiki alpinewiki"
  ENGINES_PACKAGES="alpine arch pkgs"
  ENGINES_TECH="devdocs mdn dockerhub npmjs pypi crates gopackages"
  ENGINES_SECURITY="cve exploit-db shodan virustotal cvedetails"
  #####################################################################
  ...
  if [[ ${cur} == --* ]]; then
    ...
    search)
      if [ $COMP_CWORD -eq 2 ]; then
        ...
        local all_engines="$ENGINES_DEV $ENGINES_GENERAL $ENGINES_NEWS $ENGINES_MEDIA $ENGINES_OS $ENGINES_PACKAGES $ENGINES_TECH $ENGINES_SECURITY"
        COMPREPLY=($(compgen -W "$all_engines" -- "$cur"))
      else
        # Search query - no completion
        COMPREPLY=()
      fi
      ;;
    ...
    development)
      if [ $COMP_CWORD -ge 3 ]; then
        ...
        COMPREPLY=($(compgen -W '$ENGINES_DEV' -- "$cur"))
      fi
      ;;
    ...
    engines)
      if [ $COMP_CWORD -ge 3 ]; then
        ...
        COMPREPLY=($(compgen -W '$ENGINES_GENERAL' -- "$cur"))
      fi
      ;;
    ...
    news)
      if [ $COMP_CWORD -ge 3 ]; then
        ...
        COMPREPLY=($(compgen -W '$ENGINES_NEWS' -- "$cur"))
      fi
      ;;
    ...
    media)
      if [ $COMP_CWORD -ge 3 ]; then
        ...
        COMPREPLY=($(compgen -W '$ENGINES_MEDIA' -- "$cur"))
      fi
      ;;
    ...
    os)
      if [ $COMP_CWORD -ge 3 ]; then
        ...
        COMPREPLY=($(compgen -W '$ENGINES_OS' -- "$cur"))
      fi
      ;;
    ...
    packages)
      if [ $COMP_CWORD -ge 3 ]; then
        ...
        COMPREPLY=($(compgen -W '$ENGINES_PACKAGES' -- "$cur"))
      fi
      ;;
    ...
    tech)
      if [ $COMP_CWORD -ge 3 ]; then
        ...
        COMPREPLY=($(compgen -W '$ENGINES_TECH' -- "$cur"))
      fi
      ;;
    ...
    security)
      if [ $COMP_CWORD -ge 3 ]; then
        ...
        COMPREPLY=($(compgen -W '$ENGINES_SECURITY' -- "$cur"))
      fi
      ;;
