...
_radioreference() {
  ...
  local CONFDIR="$HOME/.config/myscripts/radioreference"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/radioreference}"
  ...
  local SHORTOPTS=""
  local ARRAY="https://www.broadcastify.com/scripts/playlists/"
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - -
  # enable completions
  complete -F _radioreference radioreference
