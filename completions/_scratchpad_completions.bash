...
_scratchpad() {
  ...
  local CONFDIR="$HOME/.config/myscripts/scratchpad"
  local SCRATCHPAD_DIR="$HOME/.local/share/editors/scratchpads"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/scratchpad}"
