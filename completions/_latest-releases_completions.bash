...
_latest-releases() {
  ...
  if [[ ${cur} == --* ]]; then
    ...
    add)
      # Expects user/repo:binname:description format - no completion
      return
      ;;

    install | gitea | gitlab)
      # Expects user/repo format - no completion
      return
      ;;
