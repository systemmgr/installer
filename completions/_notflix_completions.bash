...
# @Created           :  Thursday, Jan 06, 2022 00:18 EST
# @File              :  notflix
# @Description       :
# @TODO              :
# @Other             :
...
_notflix() {
  ...
  local CONFDIR="$HOME/.config/myscripts/notflix"
  local SEARCHDIR="${CONFDIR:-$HOME/.config/myscripts/notflix}"
