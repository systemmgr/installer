...
SCRIPTSFUNCTURL="${SCRIPTSAPPFUNCTURL:-https://github.com/devenvmgr/installer/raw/GEN_SCRIPT_REPLACE_DEFAULT_BRANCH/functions}"
# - - - - - - - - - - - - - - - - - - - - - - - - -
...
run_postinst() {
  ...
  devenvmgr_run_post || exitCodeP=$((exitCodeP + 1))
